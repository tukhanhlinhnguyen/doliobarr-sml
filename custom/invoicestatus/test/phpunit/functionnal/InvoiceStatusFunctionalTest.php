...
/**
 * \file    test/phpunit/InvoiceStatusFunctionalTest.php
...
/**
 * Class InvoiceStatusFunctionalTest
 *
 ...
 *
 * @package Testinvoicestatus
 */
class InvoiceStatusFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modInvoiceStatus')->click();
		} else {
			// Disable the module
			$this->byHref('modInvoiceStatus')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/invoicestatus/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('invoicestatus/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/invoicestatus/admin/about.php');
		$this->authenticate();
		return $this->assertContains('invoicestatus/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('invoicestatuswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modInvoiceStatus_InvoiceStatusTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modInvoiceStatus_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
