...
/**
 * \file    test/phpunit/CustomfeatureFunctionalTest.php
...
/**
 * Class CustomfeatureFunctionalTest
 *
 ...
 *
 * @package Testcustomfeature
 */
class CustomfeatureFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 707050; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCustomfeature')->click();
		} else {
			// Disable the module
			$this->byHref('modCustomfeature')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/customfeature/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('customfeature/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/customfeature/admin/about.php');
		$this->authenticate();
		return $this->assertContains('customfeature/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('customfeaturewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCustomfeature_CustomfeatureTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCustomfeature_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
