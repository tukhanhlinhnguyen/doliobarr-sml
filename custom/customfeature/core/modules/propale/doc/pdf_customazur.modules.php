 ...
 */
class pdf_customazur extends ModelePDFPropales
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if ($conf->propal->multidir_output[$conf->entity]) {
			...
			if ($object->specimen) {
				...
				$file = $dir."/DEVIS-".$objectref.$nom_societe.".pdf";
			}
			...
			if (file_exists($dir)) {
				...
				for ($i = 0; $i < $nblines; $i++) {
					if ($object->lines[$i]->remise_percent) {
                        ...
                        $this->total_discount_amount += pdfGetLineTotalDiscountAmount($object, $i, $outputlangs, $hidedetails);
				...
				//	$pdf->MultiCell($this->posxdesc - 1, 3, $i+1, 0, 'R');
					...
					$total_incl_tax = $this->pdf_getlinetotalincltax($object, $i, $outputlangs, $hidedetails);
					$pdf->SetXY ($this->postotalht, $curY);
